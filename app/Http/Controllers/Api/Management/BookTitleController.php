...
use App\Services\BookTitleListService;
...
class BookTitleController extends Controller
{
    ...
    public function list(Request $request, BookTitleListService $service)
    {
    ...
    public function store(Request $request)
    {
        ...
        $this->authorize('store', BookTitle::class);
    ...
    public function destroy(Request $request, BookTitle $bookTitle)
    {
        ...
        try {
            if ($request->boolean('force')) {
                ...
                DB::commit();
                return $this->setResponse('Judul dihapus permanen.', null, 204);
            }
            $bookTitle->delete();
            DB::commit();
            return $this->setResponse('Judul berhasil dihapus.', null, 204);
