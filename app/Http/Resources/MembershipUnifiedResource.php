...
class MembershipUnifiedResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        $isMemberModel = $this->resource instanceof LibraryMember;
        if ($isMemberModel) {
            ...
            $data = [
                ...
                'is_blacklist' => $this->relationLoaded('user') ? $this->user->hasRole('Blacklist') : false,
