...
class LibraryLibrarian extends Model
{
    ...
    protected $fillable = ['library_id', 'user_id', 'is_active'];
    ...
    {
        return $this->hasOne(LibrarianApplication::class, 'user_id', 'user_id')
            ->whereColumn('librarian_applications.library_id', 'library_id')
            ->approved()
            ->latest('inspected_at');
    }
